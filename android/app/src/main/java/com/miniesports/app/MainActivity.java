...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean userLoggedIn = false;   // interstitial sirf login ke BAAD dikhao
    ...
    public class AndroidBridge {
        ...
        // ── App identity — auth.js uses this to detect WebView ──
        @JavascriptInterface
        ...
        // ── Login state signal — auth.js calls this after successful login ──
        // Isse interstitial login ke PEHLE nahi dikhega
        @JavascriptInterface
        public void onUserLoggedIn() {
            userLoggedIn = true;
            pageLoadCount = 0; // reset — fresh count from home screen
        }
    ...
    private void setupWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView v, String url) {
                ...
                // pageLoadCount sirf tab badhao jab user logged in ho
                // Login screen ya Firebase auth redirect pe interstitial NAHI dikhana
                if (userLoggedIn) {
                    pageLoadCount++;
            ...
            public boolean shouldOverrideUrlLoading(WebView v, WebResourceRequest req) {
                ...
                // Firebase auth redirect flow ke liye yeh sab URLs WebView mein hi rehne chahiye
            ...
            public boolean onCreateWindow(WebView v, boolean isDialog,
                ...
                popup.setWebViewClient(new WebViewClient() {
                    ...
                    public boolean shouldOverrideUrlLoading(WebView vv, WebResourceRequest r) {
                        ...
                        // Firebase OAuth ke baad yahan redirect aata hai
                        if (url.contains("deepsilence10161-source.github.io") ||
                            url.contains("deepsilence10161.workers.dev")) {
                            d.dismiss();
                            // Reload mat karo — Firebase onAuthStateChanged automatically fire hoga
                            // webView.reload() se ek extra page load hota tha → interstitial trigger
                            return true;
                        }
                        return false;
                    }
                ...
                popup.setWebChromeClient(new WebChromeClient() {
                    @Override public void onCloseWindow(WebView w) {
                        d.dismiss();
                        // webView.reload() hata diya — Firebase auth state listener
                        // automatically app boot karega. Reload se extra page load = interstitial bug.
                    }
                });
