...
var CACHE_NAME = 'miniesports-v29-final'; /* Bug M-1 Fix: Versioned cache — update this on every deployment */
/* Previous: 'miniesports-v1' was never updated, causing users to get stale JS/CSS */
/* Issue #39 Fix: offline.html may not exist — fall back to index.html app shell */
...
var PRE_CACHE = [
  ...
  '/index.html',
  '/manifest.json',
  /* '/offline.html', Issue #39: removed — file does not exist */
