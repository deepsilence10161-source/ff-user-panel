  ...
  window._confirmDiamondWD = function (maxDiamonds) {
    ...
    db.ref('appSettings/withdrawal').once('value', function (cfgSnap) {
      ...
      if (window._supa) {
        ...
        }).catch(function(e){ console.warn('[DiamondSystem] Withdrawal save failed:', e.message); });

        /* Deduct green_diamonds from Supabase users table */
        window._supa.rpc('increment_balance', { p_uid: U.uid, p_col: 'green_diamonds', p_amount: -diaAmt })
          .catch(function(e){ console.warn('[DiamondSystem] GD deduct failed:', e.message); });
