    ...
    users: {
      ...
      getMe: async function() {
        ...
        var { data, error } = await window._supa
          .from('users')
          .select('id,ign,email,avatar_url,coins,sky_diamonds,green_diamonds,real_money,rank_tier,rank_points,total_wins,total_kills,total_matches,city,is_creator,is_premium,clan_id,referral_code,battle_pass_tier,profile_status,ban_status,created_at')
          .eq('id', uid)
          .single();
