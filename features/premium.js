...
var TIERS=[
  {tier:1,price:49,label:'Silver',icon:'🥈',color:'#e0e0e0',glow:'rgba(224,224,224,.5)',bg:'rgba(224,224,224,.06)',border:'rgba(224,224,224,.25)',gdBonus:5,
   perks:[{i:'🚫',t:'No Ads — match join karte waqt koi ad nahi'},{i:'🥈',t:'Premium Silver Badge — profile par dikh'},{i:'💬',t:'Green Name — lobby chat mein naam hari rang ka'},{i:'🖼️',t:'Profile Photo & Banner Change — apni photo/banner lagao'},{i:'GD',t:'5 Green Diamonds har mahine (rank/badges ke liye)'}]},
  {tier:2,price:99,label:'Gold',icon:'🥇',color:'#ffd700',glow:'rgba(255,215,0,.55)',bg:'rgba(255,215,0,.07)',border:'rgba(255,215,0,.3)',gdBonus:15,best:true,
   perks:[{i:'✅',t:'Silver ke saare features shaamil'},{i:'🏠',t:'Private Match Host — doston ke saath custom room banao'},{i:'🎮',t:'Creator Program Unlock — apne matches host karo, referral commission kamao'},{i:'📡',t:'Live Stream Slot — apna YouTube/Insta stream link app mein dikhao'},{i:'GD',t:'15 Green Diamonds har mahine'}]},
