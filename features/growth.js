...
window.injectGrowthButtons = function() {
  var home = document.getElementById('homeScreen') || document.querySelector('[data-screen="home"]');
...
window.triggerMissionCheck = function(kills, rank) {
  ...
  updates['wMatches_' + wn] = (_existingVal || 0) + 1;
  if (kills >= 3) updates.todayKills = (_existingKills || 0) + kills;
