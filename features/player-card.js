...
window.showAutoResultCard = function(matchName, rankPos, kills, matchId){
  ...
  h+='<button onclick="window.open(\'whatsapp://send?text=\'+encodeURIComponent(\''+shareMsg.replace(/'/g,"\\'")+'\')+\',\'_self\')" style="width:100%;padding:13px;border-radius:13px;border:none;background:linear-gradient(135deg,#25d366,#128c7e);color:#fff;font-size:14px;font-weight:800;cursor:pointer;margin-bottom:8px"><i class="fab fa-whatsapp"></i> WhatsApp Share</button>';
