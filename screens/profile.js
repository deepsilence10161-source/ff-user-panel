...
function renderProfile() {
  ...
  var bannerStyle = bannerImg
    ...
    : 'background:linear-gradient(120deg,#0d0d1a 0%,#181030 45%,#0d1a2e 100%)';
  ...
  h += '<div onclick="document.getElementById(\'profBannerIn\').click()" title="Change banner" style="width:30px;height:30px;border-radius:9px;background:rgba(0,0,0,.45);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.15);display:flex;align-items:center;justify-content:center;cursor:pointer"><i class="fas fa-image" style="font-size:12px;color:#ccc"></i></div>';
  ...
  h += '<div class="prof-ava" style="width:84px;height:84px;font-size:32px;border:3px solid ' + rk.color + ';box-shadow:0 0 18px ' + rk.color + '88,0 0 0 3px rgba(5,5,7,.8);' + ringAnim + '">' + av + '</div>';
