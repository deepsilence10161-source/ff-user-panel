...
function renderProfile() {
  ...
  /* ── Achievements button ── */
  h += '<button class="prof-btn" onclick="window.showAchievementsV3&&showAchievementsV3()" style="background:linear-gradient(135deg,rgba(255,215,0,.06),rgba(255,140,0,.04));border:1px solid rgba(255,215,0,.15);color:#ffd700;margin-bottom:8px">';
  h += '<span style="margin-right:auto"><i class="fas fa-medal" style="margin-right:8px;color:#ffd700"></i>Achievements</span>';
  var _achCount = Object.keys((UD&&UD.achievementsV3)||{}).length;
  h += '<span style="font-size:12px;background:rgba(255,215,0,.08);padding:2px 8px;border-radius:10px">' + _achCount + ' earned</span></button>';
  /* ── Career Stats Card ── */
